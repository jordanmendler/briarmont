...
$subPage = mb_strtolower($segments[array_key_last($segments)]) ?? '';
...
if (empty($embedUrl) && (empty($subPage) || $subPage == $subfolder_prefix)) {
    ?>
    <section>
        <div class="is-flex is-flex-direction-column is-align-items-center content-wrap">
            <a href="/<?=$subfolder_prefix?>/" title="Briarmont Estates & Mansion">
                <img src="/<?= $subfolder_prefix ?>/images/briarmont-logo.png" class="logo-img" alt="Briarmont Estates & Mansion" />
            </a>
            <div class="container">
                <div class="columns is-multiline">
                    ...
                    <div class="column is-12-mobile is-4-tablet is-flex">
                        <a href="/<?= $subfolder_prefix ?>/briarmont-estates-sylmar" class="is-flex is-flex-direction-column is-justify-content-stretch has-width-100">
                            <div class="box is-flex is-flex-direction-column is-justify-content-stretch has-height-100">
                                <figure class="image is-4by3">
                                    <img src="/<?= $subfolder_prefix ?>/images/Briarmont_Estates_Sylmar.jpg" />
                                </figure>
                                <div class="content mt-4">
                                    <ul>
                    ...
                    <div class="column is-12-mobile is-4-tablet is-flex">
                        <a href="/<?= $subfolder_prefix ?>/briarmont-estates-lake-palmdale" class="is-flex is-flex-direction-column is-justify-content-stretch has-width-100">
                            <div class="box is-flex is-flex-direction-column is-justify-content-stretch has-height-100">
                                <figure class="image is-4by3">
                                    <img src="/<?= $subfolder_prefix ?>/images/Briarmont_Estates_Lake_Palmdale.png" />
                                </figure>
                                <div class="content mt-4">
                                    <ul>
                    ...
                    <div class="column is-12-mobile is-4-tablet is-flex">
                        <div class="is-flex is-flex-direction-column is-justify-content-stretch has-width-100">
                            <div class="box is-flex is-flex-direction-column is-justify-content-stretch has-height-100">
                                <figure class="image is-4by3">
                                    <img src="/<?= $subfolder_prefix ?>/images/SCENE_08-NORTH.png" />
                                </figure>
                                <div class="content mt-4">
                                    <ul>
                                        ...
                                        <li><a href="/<?= $subfolder_prefix ?>/container-city" >Presentation</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        document.getElementById('emailForm').addEventListener('submit', function (e) {
            ...
            grecaptcha.ready(function () {
                grecaptcha.execute('6LeVTOMrAAAAANPoVCUoBOfr9EPkbTMjXHwnVth0', { action: 'submit_email' }).then(function (token) {
                    fetch('/<?= $subfolder_prefix ?>/submit.php', {
                        method: 'POST',
